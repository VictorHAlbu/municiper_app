...
ActiveRecord::Schema.define(version: 2022_08_25_194435) do
  ...
  create_table "residents", force: :cascade do |t|
    ...
    t.index ["health_card_document"], name: "index_residents_on_health_card_document"
    t.index ["phone"], name: "index_residents_on_phone"
  end
